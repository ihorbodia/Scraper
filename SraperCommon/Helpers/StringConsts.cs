namespace Sraper.Common
{
    ...
    {
        public const string FilePathLabelConst = "Chosen file:";
        public const string CountryFolderPathLabelConst = "Chosen folder:";
        public const string FileProcessingLabelConst = "Status:";
